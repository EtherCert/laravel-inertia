        ...
        >
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    ...
                    components, as well as all of our site templates for a single one-time purchase.
                </p>
            </div>
                ...
                <div class="flex flex-col  items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <P class="text-accent font-normal">Email me at test@gmail.com</P>
                        </div>
                    </div>
                     <div class="flex flex-col lg:flex-row gap-x-4">
                        <div class="text-accent rounded-sm w-14 h-14 flex items-start justify-center mt-2 mb-4 lg:mb-0 text-2xl">
                        ...
                        <div>
                            <h4 class="font-body text-xl mb-1">Current Locations</h4>
                            <P class="mb-1 text-paragraph">Gaza Palestine.</P>
