    ...
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <button @click="showMobileMenu = !showMobileMenu"
                    ...
                    type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
            ...
            <div  class="w-full md:block md:w-auto"
                ...
                <ul class="flex flex-col
                        ...
                        bg-light-secondary
                        rounded-lg
                        border border-light-tail-500 dark:border-dark-navy-500
                        md:flex-row
                        md:space-x-8
                        md:mt-0
                        md:font-medium
                        md:border-0
                        dark:bg-datk-secondary darck:border-gray-700">
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white bg-light-tail-500 dark:bg-dark-navy-100 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
                    </li>
                    <li>
