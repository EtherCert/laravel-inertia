    ...
    <div class="container mx-auto h-full">
        <div class="flex flex-col md:flex-row items-center h-full pt-8"
            ...
            <div class="flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Hi, I'm Samia</p>
                ...
                <div class="pt-12">
                    <h5 class="text-lg items-center text-black dark:text-white mb-2 justify-center lg:justify-start">Follow me on</h5>
                    <div class="flex items-center mb-6">
                        <a class="w-12 h-12 rounded-full flex items-center justify-center
                                  border border-white text-black hover:bg-light-secondary
                                  hover:border-light-secondary dark:hover:bg-dark-secondary
                                  dark:hover:border-dark-secondary mr-3 sm:mr-4 dark:text-white"
                        href="facebook.com">
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                    <img class="rounded-lg max-w-[600px]" src="http://localhost:8000/img/hero.jpg" alt="Hero"/>
            </div>
        </div>
    </div>
</section>
